...
如果不想使用 Spring 配置，可以通过 [API 的方式](http://dubbo.apache.org/zh-cn/docs/user/configuration/api.html) 进行调用。
...
1. 该接口需单独打包，在服务提供方和消费方共享 [↩︎](http://dubbo.apache.org/zh-cn/docs/user/quick-start.html#fnref1)
2. 对服务消费方隐藏实现 [↩︎](http://dubbo.apache.org/zh-cn/docs/user/quick-start.html#fnref2)
3. 也可以使用 IoC 注入 [↩︎](http://dubbo.apache.org/zh-cn/docs/user/quick-start.html#fnref3)