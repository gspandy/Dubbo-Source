...
有关 XML 的详细配置项，如果不想使用 Spring 配置，而希望通过 API 的方式进行调用
...
![dubbo-config](images/dubbo-config.jpg)
...
1. `2.1.0` 开始支持，注意声明：`xmlns:p="http://www.springframework.org/schema/p"` [](http://dubbo.apache.org/zh-cn/docs/user/configuration/xml.html#fnref1)
